...
describe('Constructor test', function () {
    ...
    it('should contruct from bigint', function () {
        ...
        big.unscaledValue().should.be.eq(123n);
    });
    ...
    it('should contruct from string', function () {
        ...
        big.unscaledValue().should.be.eq(112333n);

        const big2 = Big('1000000000000000000000');
        big2.scale().should.be.eq(0);
        big2.precision().should.be.eq(22);
        big2.unscaledValue().should.be.eq(1000000000000000000000n);
    });
    ...
    it('should contruct from string and math context', function () {
        ...
        big.unscaledValue().should.be.eq(11233n);
        ...
        big2.unscaledValue().should.be.eq(10000n);
    });
    ...
    it('should contruct from an integer and scale', function () {
        ...
        big3.unscaledValue().should.be.eq(123n);
    ...
    it('should build from unsafe number and scale', function () {
        ...
        big.unscaledValue().should.be.eq(9007199254740992n);
        ...
        big2.unscaledValue().should.be.eq(9007199254740992n);
    ...
    it('should build from max value', function () {
        ...
        big.unscaledValue().should.be.eq(17976931348623157n);
    });
    ...
    it('should build from min value', function () {
        ...
        big.unscaledValue().should.be.eq(5n);
    });
