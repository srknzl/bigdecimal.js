...
const { BigDecimal, MathContext, RoundingMode } = require('../lib/bigdecimal.js');
...
const initialValue = '131111221231078945097345094107312093867540973164012222222222222222222222222222222222222222221232312.123123';
const precision = 123;
Big.DP = precision;
Big.RM = 1;
